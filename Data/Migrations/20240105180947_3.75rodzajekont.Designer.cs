...
namespace mapkowanie.Data.Migrations
{
    ...
    [Migration("20240105180947_3.75rodzajekont")]
    partial class _375rodzajekont
    {
            ...
            modelBuilder.Entity("mapkowanie.Models.Konto", b =>
                {
                    ...
                    b.HasOne("mapkowanie.Models.Rodzaje", "Rodzaje")
                        .WithMany()
                        .HasForeignKey("RodzajeId");
